...
f = open(str(the_time)+'predict.csv', 'w')
...
output_video_path = str(the_time)+'predict.mp4'
...
points=[]
vis=[]
with open(str(the_time)+'predict.csv', newline='') as csvFile:
...
#print(predict_hit)
output_name = str(the_time)+'predict_shot.csv'
